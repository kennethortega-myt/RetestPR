 ...
 * Colocar en el archivo de interfaces o al inicio deservicio.
 */
...
export class SettingReportActasService {
  private readonly baseUrl = environment.apiUrl;

  private readonly urls = {
    reportConfigurationUrl: this.baseUrl + '/reporte-actas',
  };
  ...
  public updateReportConfiguration$(
    ...
    return this.request
      .post<ISetReportConfigResponse>(this.urls.reportConfigurationUrl + "/actualizar", params)
      .pipe(
        map((response) => {
          return {
            success: true
