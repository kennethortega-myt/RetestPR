...
import pe.gob.onpe.consultaopbackend.model.dto.reporte.ReporteFiltrosCodigosDto;
import pe.gob.onpe.consultaopbackend.model.dto.reporte.ReporteFiltrosValoresDto;
...
public class ReporteUtils {
    ...
    public static String getJsonFromRequest(ReporteRequest requestReporte) {
        ...
        ReporteFiltrosValoresDto jsonRequest = ReporteFiltrosValoresDto.builder()
                ...
                .tipoEleccion(TipoEleccionEnum.obtenerDescripcion(requestReporte.getIdEleccion().longValue()))
