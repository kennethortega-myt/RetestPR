...
import pe.gob.onpe.consultaopbackend.model.dto.FiltroProcesoAmbitoDto;
...
public class ProcesoController {
    ...
    public ResponseEntity<GenericResponse<List<MaeProcesoElectoral>>> listProcesos() {
        GenericResponse<List<MaeProcesoElectoral>> genericResponse = new GenericResponse<List<MaeProcesoElectoral>>();

        genericResponse.setSuccess(Boolean.TRUE);
        genericResponse.setData(this.maeProcesoElectoralService.findAll());

        return new ResponseEntity<GenericResponse<List<MaeProcesoElectoral>>>(genericResponse, HttpStatus.OK);
    }
    ...
    public ResponseEntity<GenericResponse<ProcesoElectoralActivoResponse>> obtenerProcesoActivo() {
        GenericResponse<ProcesoElectoralActivoResponse> genericResponse = new GenericResponse<ProcesoElectoralActivoResponse>();
        ...
        return new ResponseEntity<GenericResponse<ProcesoElectoralActivoResponse>>(genericResponse, HttpStatus.OK);
    }
    ...
    public ResponseEntity<GenericResponse<ProcesoAmbitoDto>> getTipoAmbito(@RequestBody FiltroProcesoAmbitoDto filtroProcesoAmbitoDto) {
        GenericResponse<ProcesoAmbitoDto> genericResponse = new GenericResponse<ProcesoAmbitoDto>();
        ...
        return new ResponseEntity<GenericResponse<ProcesoAmbitoDto>>(genericResponse, HttpStatus.OK);
    }
