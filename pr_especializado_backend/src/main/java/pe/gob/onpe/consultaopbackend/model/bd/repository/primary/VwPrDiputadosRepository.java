...
import pe.gob.onpe.consultaopbackend.model.bd.documents.VwPrDiputados;
...
public interface VwPrDiputadosRepository extends MongoRepository<VwPrDiputados, Integer> {
	...
	List<VwPrDiputados> findByTipoEleccionAndTipoFiltroAndUbigeoNivel01(Integer tipoEleccion, String tipoFiltro, Integer ubigeo1);
