...
import pe.gob.onpe.consultaopbackend.sasa.dto.LoginDatosOutputDto;
import pe.gob.onpe.consultaopbackend.sasa.dto.LoginInputDto;
    ...
    public String getToken() {
        if (cachedToken == null) {
            try {
                ...
                input.setUsuario("USUARIO_PERIODISTA");  // 👈 usuario de pruebas
                ...
                throw new RuntimeException("No se pudo generar token de prueba para Swagger", e);
            }
        }
        return cachedToken;
    }
