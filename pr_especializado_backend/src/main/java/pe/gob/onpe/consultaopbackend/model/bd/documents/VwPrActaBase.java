...
public class VwPrActaBase extends Auditoria {
    ...
    @Field(name = "c_digito_chequeo_instalacion_sufragio")
    private String digitoChequeoInstalacionSufragio;
    ...
    private Integer nSolucionTecnologica;

    @Field(name = "c_descripcion_solucion_tecnnologica")
    private String cDescripcionSolucionTecnologica;
