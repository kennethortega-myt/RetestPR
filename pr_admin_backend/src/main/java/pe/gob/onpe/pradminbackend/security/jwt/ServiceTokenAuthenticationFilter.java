...
public class ServiceTokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            Claims claims = tokenProvider.getClaimsFromAuthToken(authToken); // Usamos el provider para obtener los claims
            ...
            // Si el token está mal formado o expirado, el JWTAuthenticationFilter se encargará de reportar el error.
