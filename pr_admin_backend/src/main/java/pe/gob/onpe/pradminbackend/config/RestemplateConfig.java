...
public class RestemplateConfig {
    private static final int TIMEOUT_MIGRACION = 60; // minutos
    ...
    private ClientHttpRequestFactory getClientHttpRequestFactory(String tipo) {
        ...
        if(tipo.equals("migracion")) {
            config = RequestConfig
                    .custom()
                    .setConnectionRequestTimeout(TIMEOUT_MIGRACION, TimeUnit.MINUTES)
                    .setResponseTimeout(TIMEOUT_MIGRACION, TimeUnit.MINUTES)
                    .build();
